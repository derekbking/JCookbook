...
class _ZoomScaffoldState extends State<ZoomScaffold>
 ...
 void initState() {
  ...
  createContentDisplay() {
    var contentDisplay = zoomAndSlideContent(new Container(
      child: new Scaffold(
    ...
    if (Provider.of<MenuController>(context).state == MenuState.open)
    {
      return GestureDetector(
        child: contentDisplay,
        onTap: () {
          Provider.of<MenuController>(context).close();
        }
      );
    }
